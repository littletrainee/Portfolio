...
void printallplayerhand(string player1name, string player2name, vector<int> player1hand, vector<int> player2hand, int temphand){
	cout << player1name << ": ";
...
int main(void){
	...
	// game start drawcard and sort, player1 is 5 other(player2) is 4
	DrawCardAndSort(player1hand, 0);
	DrawCardAndSort(player2hand, 1);
	// print all playerhand 
	printallplayerhand(player1name, player2name, player1hand, player2hand, temphand);
	...
	while (returnbool){
		...
		if (gameturn == 0){													   // player1 wincheck function
			tie(player2hand, temphand) = Discard(player2hand); // player2 discard from player3hand to temphand
			returnbool = Check(player1hand, temphand, returnbool); // check player1 is winning
			if (returnbool){ // if player1 isn't winning(ron)
					...
					printallplayerhand(player1name, player2name, player1hand, player2hand, temphand); // print all playerhand
			...
			returnbool = Check(player2hand, temphand, returnbool);// check player2 is winning
